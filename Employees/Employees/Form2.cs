...
namespace Employees
{
    public partial class Form2 : Form
    {
        ...
        private void Form2Load(object sender, EventArgs e)
        {
            ...
            InsertDataToForm(tot, men, women, pens, menp, womenp, toPens, midAge);
        }

        private void InsertDataToForm(int tot, int men, int women, int pens, int menp, int womenp, double toPens, double midAge)
        {
